...
export default function ProfileCard() {
  ...
  return (
      <Card className={styles.profile_card__wrapper}>
        ...
        alt="avatar"/>
         <Form
          ...
          <Form.Group controlId="formFile" className="mb-3">
            <Form.Label className={styles.profile_add_photo}>
        ...
        <ListGroup className={styles.profile_card__userabout}>
          ...
          <ListGroup.Item className={styles.profile_card__userabout_age}>
            Возраст:
          ...
          <ListGroup.Item className={styles.profile_card__userabout_tg}>
